...
def generate_final_report(question, db, selected_files):
    ...
    prompt2 = (
        ...
        "Introducción:\n"
        "   - Preserva esta sección. Plantea el contexto y la pregunta central. Usa un hallazgo inesperado (que provenga ÚNICAMENTE de los reportes seleccionados), para captar la atención.\n\n"
